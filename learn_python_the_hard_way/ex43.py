...
class Scene(object):
  def enter(self):
    print("This scene is not implemented")
  ...
  def enter(self):
    ...
    if action == "shoot!":
      ...
      print(dedent("""
        ...
        and slide right as the Gothon's blaster cranks a laser past your
        head. In the middle of your artful
        dodge your foot slips and you bang your head on the metal wall
        and pass out. You wake up shortly after only
      ...
      print(dedent("""
        ...
        know Lbhe zbgure vf fb sng, jura fur fvgf nebhaq gur
        ubhfr, fur fvgf nebhaq gur ubhfr. The Gothon stops,
        tries not to laugh, then busts out laughing and can't
        move. While he's laughing you run up and shoot him square in the
        head putting him down, then jump through
...
class LaserWeaponArmory(Scene):
  def enter(self):
    print(dedent("""
      ...
      room for more Gothons that might be hiding. It's
      dead quiet, too quiet. You stand up and run to the far side
      of the room and find the neutron bomb in its
      container There's a keypad lock on the box and you need the code
      to 10 get the bomb out.  If you get the code wrong 10 times
    ...
    if guess == code:
      ...
      print(dedent("""
        ...
        a sickening melting sound as the mechanism is
...
class TheBridge(Scene):
  def enter(self):
    print(dedent("""
      You burst onto the Bridge with the netron destruct
      bomb under your arm and surprise 5 Gothons who are trying
      to take control of the ship. Each of them has an even
      uglier clown costume than the last. They haven't pulled
      their weapons out yet, as they see the active bomb under
    ...
    if action == "throw the bomb":
      print(dedent("""
        ...
        a Gothon shoots you right in the back killing
        you. As you die you see another Gothon frantically try
        to disarm the bomb. You die knowing they will
